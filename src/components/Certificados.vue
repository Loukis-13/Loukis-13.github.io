...
<template>
    <a v-for="c in lista_certificacoes" class="col xl2 l3 s6" :href="c.url" target="_blank">
        <img class="responsive-img" :src="`img/certificações/${c.nome}.png`" :alt="c.nome" :title="c.nome" style="padding: 4%;">
    </a>
</template>